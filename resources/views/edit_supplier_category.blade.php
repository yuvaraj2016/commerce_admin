                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <i class="">Edit Supplier Category</i>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="dropzone" action="{{route('supplier_categories.update',['supplier_category'=>$suppliercategory['id']]) }}" method="post" id="editsuppliercat"
                        ...
                        <div class="col-sm-4 ">
                                                            ...
                                                            <input name="title" value="{{ old('title',$suppliercategory['title']) }}" class="summernote-simple form-control" required>
                                              
                                                        </div>
                                                       
                                                        <div class="col-sm-4 ">
                                                            <label class="col-form-label text-md-right ">Supplier Category Desc</label>
                                                            <textarea name="supplier_cat_desc" class="summernote-simple form-control" required>{{ old('supplier_cat_desc',$suppliercategory['supplier_cat_desc']) }}</textarea>
                                                        ...
                                                        <div class="col-sm-4 ">
                                                            ...
                                                            <select  class="js-example-basic-single col-sm-12" name="status_id" id="" placeholder="Status" required class="form-control selectric" required>
                                                                ...
                                                                @foreach($statuses as $status)
                                                                    <option value="{{ $status['id'] }}" {{ ($suppliercategory['status_id'] == $status['id']) ? "selected":(old("status_id") == $status['id'] ? "selected":"") }}>{{ $status['status_desc'] }}</option>
                                                                @endforeach
                                                            </select>
