        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Edit Vendor Stores Image</h4>
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <i class="">Edit Vendor Stores Image  </i>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                            ...
                                            <b>{{ $editdata['vendor_store_name'] }}</b>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4 offset-1 card">
                                                            ...
                                                            <div class="card-block">
                                                                <form id="uploadform" action="{{url('assets/storeimage/vendorstore/'.$editdata['id']) }}" method="post" id="addprocat"
                            ...
                            <div class="form-group row mb-5">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                        ...
                                        <a href="{{ url('vendorstores/'.$editdata['id'].'/edit') }}"
