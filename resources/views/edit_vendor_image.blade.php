                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                            ...
                                            <b>{{ $editdata['vendor_category_desc'] }}</b>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4 offset-1 card">
                                                            ...
                                                            <div class="card-block">
                                                                <form id="uploadform" action="{{url('assets/storeimage/vendors/'.$editdata['id']) }}" method="post" id="addprocat"
                            ...
                            <div class="form-group row mb-5">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                        ...
                                        <a href="{{ url('vendors/'.$editdata['id'].'/edit') }}"
