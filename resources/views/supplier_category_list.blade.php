...
@section('content')
    ...
    <div class="section-header-button">
        <a href="{{ route('supplier_categories.create') }}" class="btn btn-primary">Add New</a>
    </div> 
            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('supplier_cat.index') }}">Supplier Category List</a>
                        </li>
                    ...
                    <div class="card-header table-card-header">
                        <div class="row">
                            <div class="section-header-button col-md-4">
                                <a href="{{ route('supplier_categories.create') }}" class="btn btn-primary" style="box-shadow: 0 2px 6px #acb5f6;
                    ...
                    border-color: #6777ef;border-radius:30px">Add New</a>
                            ...
                            <div class="section-header-button col-md-3 ">
                                ...
                                <ul id="pagination" class="float-right m-0 p-0">
                                        <li><a href="{{ route('supplier_cat.index',$page=1) }}" class="btn btn-primary @if($pagination['current_page']==1) {{ "disabled" }} @endif">First</a></li>
                                        @php
                                        ...
                                        @endphp
                                        <li><a href="{{ route('supplier_cat.index',$page) }}" class="btn btn-primary">Previous</a></li>
                                        @php
                                        }
                                        @endphp
                        ...
                        <li class="{{ $isCurrentPage ? 'active' : '' }}" >
                                        ...
                                        // echo
                                        @endphp
                                        <li> <a href="{{ route('supplier_cat.index',$page) }}" class="btn btn-primary">Next</a></li>
                                        @php
                                        }
                                        ...
                                        {
                                        @endphp
                                        <li> <a href="{{ route('supplier_cat.index',$pagination['total_pages']) }}" class="btn btn-primary float-right">Last</a> </li>
                            ...
                            <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                ...
                                {{-- @dd($prodcategories) --}}
                                    ...
                                    <td>
                                        ...
                                        <td>{{ $suppliercategory['status_desc'] }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <ul class="list-group list-inline ml-1">
                                                    <li class="list-group-item border1"><a href="{{ url('supplier_categories/'.$id) }}" class=" d-inline font1 view-confirmation" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ url('supplier_categories/'.$id) }}" class="btn btn-success d-inline" style="border-radius:30px;box-shadow: 0 2px 6px #acb5f6;
                                                        background-color: #6777ef;
                                                        border-color: #6777ef;"><i class="icofont icofont-eye"></i>View&nbsp;&nbsp;</a>&nbsp;&nbsp;

                                                <a href="{{ url('supplier_categories/'.$id.'/edit') }}" class="btn btn-info d-inline text-center" style="border-radius:30px;box-shadow: 0 2px 6px #acb5f6;
                                                        background-color: #6777ef;
