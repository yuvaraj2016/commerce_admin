            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="dropzone" action="{{route('vendorstores.update',['vendorstore'=>$vendorstores['id']]) }}" method="post" id="editprosubcat"
                        ...
                        <div class="col-sm-4">
                                                        ...
                                                        <select  class="js-example-basic-single col-sm-12" name="vendor_id" id="" placeholder="Vendor" required class="form-control selectric" required>
                                                            ...
                                                            @foreach($vendors as $vendorss)
                                                                <option value="{{  $vendorss['id'] }}" {{ ($vendorstores['vendor_id'] == $vendorss['id']) ? "selected":(old("vendor_id") ==  $vendorss['id'] ? "selected":"") }}>{{ $vendorss['vendor_name'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <a href="{{ url('vendorstore/'.$vendorstores['id'].'/edit/assets') }}" class="btn btn-blue">Edit Image</a>
                                                        </div>
                                                        <div class="col-sm-4">
<label class="col-form-label text-md-right ">Vendor Stored Name</label>
<input type="text" id="" name="vendor_store_name" value="{{ old('vendor_store_name',$vendorstores['vendor_store_name']) }}" class="form-control" required>
</div>
...
<input type="text" id="" name="vendor_store_location" value="{{ old('vendor_store_location',$vendorstores['vendor_store_location']) }}" class="form-control" required>
</div>
<div class="col-sm-4">
<label class="col-form-label text-md-right ">Vendor Stored Address</label>
<input type="text" id="" name="vendor_store_address" value="{{ old('vendor_store_address',$vendorstores['vendor_store_address']) }}" class="form-control" required>
</div>

<div class="col-sm-4">
<label class="col-form-label text-md-right ">Vendor Stored Contact</label>
<input type="number" id="" name="vendor_store_contact" value="{{ old('vendor_store_contact',$vendorstores['vendor_store_contact']) }}" class="form-control" required>
</div>
...
<div class="col-sm-4">
<label class="col-form-label text-md-right ">Vendor Stored Latitude</label>
<input type="text" id="" name="latitude" value="{{ old('latitude',$vendorstores['latitude']) }}" class="form-control" required>
</div>

<div class="col-sm-4">
<label class="col-form-label text-md-right ">Vendor Stored Longitude</label>
<input type="text" id="" name="longitude" value="{{ old('longitude',$vendorstores['longitude']) }}" class="form-control" required>
</div>
...
<div class="col-sm-4">
                                                        ...
                                                        <select  class="js-example-basic-single col-sm-12" name="status_id" id="" placeholder="Status" required class="form-control selectric" required>
                                                            ...
                                                            @foreach($statuses as $status)
                                                                <option value="{{ $status['id'] }}" {{ ($vendorstores['status_id'] == $status['id']) ? "selected":(old("status_id") == $status['id'] ? "selected":"") }}>{{ $status['status_desc'] }}</option>
                                                            @endforeach
                                                        </select>
