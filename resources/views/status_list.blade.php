                                ...
                                {{-- @dd($prodcategories) --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <ul class="list-group">
                                                    <li class="list-group-item border1"><a href="{{ url('status/'.$id) }}" class=" d-inline btn btn-link font1"><i class="icofont icofont-eye"></i>View&nbsp;&nbsp;</a>&nbsp;&nbsp;</li>
                                                    <li class="list-group-item border1"><a href="{{ url('status/'.$id.'/edit') }}" class=" d-inline text-center btn btn-link font1"><i class="icofont icofont-ui-edit"></i>Edit&nbsp;&nbsp;</a>&nbsp;&nbsp;</li>
