    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('ordertype.store') }}" class="swa-confirm"  method="post" id="addorder"
                            ...
                            <div class="col-sm-4 offset-1">
                                                        <label class="col-form-label text-md-right ">Order Title</label>
                                                        <input name="title" value="{{ old('title') }}" class="summernote-simple form-control" required>
               
                                                        </div>
                            <div class="col-sm-4 offset-1">
                                <label class="col-form-label text-md-right c">Order Type Desc</label>
                                
                                    <textarea name="order_type_desc" class="summernote-simple form-control" required>{{ old('order_type_desc') }}</textarea>
