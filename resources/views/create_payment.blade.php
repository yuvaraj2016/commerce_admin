                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <i class="">Create Payment Status</i>
                          
                        </li>
                      
                        <li class="breadcrumb-item"><a href="{{ route('payment.index') }}">Payment Status</a>
                        </li>
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('payment.store') }}" class="swa-confirm"  method="post" id=""
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                    <button type="submit" id="submit" class="btn btn-primary">Create Payment Status</button>
                                </div>
                            </div>
